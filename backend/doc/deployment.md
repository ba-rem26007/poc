...
graph LR
    ...
    subgraph "Preprod Environment (preprod-po.d1dev.fr)"
        PreprodGit[Git Pull / Manual Deploy] -->|bash deploy.sh| PreprodServer[Debian Server with Traefik]
    end
...
sequenceDiagram
    ...
    participant Server as Debian Server (poc.d1dev.fr / preprod-po.d1dev.fr)

    Dev->>GitHub: git push origin main
    GitHub->>PHPUnit: Run 16 PHPUnit tests & React Build
